...
public final class Constants
{
  ...
  public static final class ShooterConstants
  {
    ...
    public static final double AmpShootMinSpeed = 23.0;
  }
  ...
  public static final class IntakeArmConstants
  {
    ...
    public static final double ArmCruiseVelocity = 200;//700;
    public static final double ArmAcceleration = 200;//500;
