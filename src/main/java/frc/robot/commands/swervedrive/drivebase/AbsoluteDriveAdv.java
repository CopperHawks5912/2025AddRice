...
public class AbsoluteDriveAdv extends Command
{
  ...
  public void execute()
  {
    ...
    translation = SwerveMath.limitVelocity(translation, swerve.getFieldVelocity(), swerve.getPose(),
                                           SwerveConstants.LoopTime, SwerveConstants.RobotMass, List.of(SwerveConstants.Chassis),
    ...
    {
      resetHeading = true;
      swerve.drive(translation, ( SwerveConstants.TurnConstant * -headingAdjust.getAsDouble()), true);
    } else
    {
