...
public class AllianceLEDCommand extends Command {
  ...
  public void execute() { 
    ...
    if( alliance.get() == Alliance.Blue)
      m_addressableLEDSubsystem.setLEDMode(LEDConstants.LEDModeAllianceBlue);
    else if( alliance.get() == Alliance.Red)
      m_addressableLEDSubsystem.setLEDMode(LEDConstants.LEDModeAllianceRed);   
  }
